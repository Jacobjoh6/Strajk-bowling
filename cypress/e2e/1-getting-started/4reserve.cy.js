describe('example to-do app', () => {
    ...
    it('Confirms booking and recieves confirmation', () => {
      ...
      // cy.get('.confirmation__details').find('section').eq(-3).should('include.value', 2)
      // cy.get('.confirmation__details').find('section').eq(-2).should('have.value', 1)
      cy.get('.confirmation__details').find('p').last().should('have.text', "340 sek")
